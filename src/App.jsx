...
function App() {
  ...
  return (
    <div
      ...
      <iframe
        className="absolute left-[50%] translate-x-[-50%] top-[60vh] md:top-[80vh] md:border-[15px] border-white rounded-md md:shadow-md shadow-gray-500 w-full h-[300px] md:w-[750px] md:h-[400px] p-3 md:p-0"
